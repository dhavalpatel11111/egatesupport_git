            ...
            <table width="100%" style="" cellpadding="3px">
                ...
                ?>
                    <tr>
                        ...
                        <?php
                        $invoice_contract_amount = getTableFiltereddc("invoice_contract", "invoice_id", $_GET["id"], "contract_id", $invoice_data['id'], "amount");
                        ...
                        <td style="text-align: center;"><?php echo number_format($contract_amount, 0, '.', ','); ?></td>
                        ?>
                    </tr>
