...
private $digitArray = array(0=>"00110",1=>"10001",2=>"01001",3=>"11000",4=>"00101",5=>"10100",6=>"01100",7=>"00011",8=>"10010",9=>"01010");
	function __construct($value,$into=1, $filename = 'barcode.gif', $width_bar=200, $height_bar=65, $show_codebar=false) { 	 
  ...
  if ($show_codebar) {
    imagestring($img, 5, 0, $height_bar+5, " ".$value, imagecolorallocate($img, 0, 0, 0));
  	...
  	$this->put_img($img,$file='test.png',$value,$filename);
	...
	function put_img($image,$file='test.png',$value,$filename){
		if($this->into){
			imagegif($image,$this->file);
			  ...
			  ImagePNG($image,'uploads/barcoads/'.$filename.'.png');
