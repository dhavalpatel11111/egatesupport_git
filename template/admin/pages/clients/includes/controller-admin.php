    ...
    switch ($_GET['modal']) {
        ...
        break;
         ...
         case "EditmodelUsageEditactualstatus";
            $usageReport = getRowById("actual_report", $_GET['id']);
            $modelimage = getSingleValue("models", "image", $usageReport['asset_id']);
        break;
        ...
        case "invoiceTemplate":
            ...
            $template = getTable("invoiceTemplate");
            break;
        case "projectAdd":
            $clients = getTable("clients");
            break;
...
if ($route == "invoiceTemplateEmail") {
    ...
    if (!empty($collection_user)) {
        ...
        if (!file_exists($invoicePath)) {
            ...
            $subject = str_replace($search, $replace, $emailtemplete['subject']);

            $message = str_replace($searchinvoice, $replaceinvoice, $emailtemplete['message']);
